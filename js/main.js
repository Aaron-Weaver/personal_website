    	   ...
    	   size: '150',
			...
			onStep: function(from, to, percent) {
                ...
                if(Math.round(percent) == 100) {
                    $(this.el).find('.percent').text('Expert');
                }
                else if(Math.round(percent) == 75) {
                    $(this.el).find('.percent').text('Advanced');
                }
                else if(Math.round(percent) == 50) {
                    $(this.el).find('.percent').text('Intermediate');
                }
                else if(Math.round(percent) == 25) {
                    $(this.el).find('.percent').text('Beginner');
                }
                //$(this.el).find('.percent').text('lol');
			}
	 });
}, {
  triggerOnce: true,
